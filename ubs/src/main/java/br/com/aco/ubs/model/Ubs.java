...
public class Ubs {
    ...
    public Ubs(int cod_cnes, double vlr_latitude, double vlr_longitude, int cod_munic, String nom_estab, String dsc_endereco, String dsc_bairro, String dsc_cidade, String dsc_telefone, String dsc_estrut_fisic_ambiencia, String dsc_adap_defic_fisic_idosos, String dsc_equipamentos, String dsc_medicamentos) {
